 ...
 */
final class Version20190204153420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(128) NOT NULL, slug VARCHAR(512) NOT NULL, detail VARCHAR(512) DEFAULT NULL, sex VARCHAR(8) NOT NULL, age INT DEFAULT NULL, body LONGTEXT NOT NULL, picture1 VARCHAR(512) DEFAULT NULL, picture2 VARCHAR(512) DEFAULT NULL, picture3 VARCHAR(512) DEFAULT NULL, is_active TINYINT(1) NOT NULL, name VARCHAR(32) DEFAULT NULL, INDEX IDX_6AAB231FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE presentation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(128) NOT NULL, body LONGTEXT NOT NULL, is_active TINYINT(1) NOT NULL, slug VARCHAR(512) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, price VARCHAR(16) DEFAULT NULL, UNIQUE INDEX UNIQ_9B66E893A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE app_users (id INT AUTO_INCREMENT NOT NULL, role_id INT DEFAULT NULL, username VARCHAR(64) NOT NULL, password VARCHAR(64) NOT NULL, email VARCHAR(254) NOT NULL, is_active TINYINT(1) NOT NULL, firstname VARCHAR(64) NOT NULL, lastname VARCHAR(64) NOT NULL, address VARCHAR(256) NOT NULL, zip_code VARCHAR(16) NOT NULL, city VARCHAR(64) NOT NULL, longitude DOUBLE PRECISION NOT NULL, latitude DOUBLE PRECISION NOT NULL, avatar VARCHAR(512) DEFAULT NULL, phone_number VARCHAR(16) DEFAULT NULL, cell_number VARCHAR(16) DEFAULT NULL, is_validated TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, connected_at DATETIME DEFAULT NULL, type VARCHAR(32) NOT NULL, UNIQUE INDEX UNIQ_C2502824F85E0677 (username), UNIQUE INDEX UNIQ_C2502824E7927C74 (email), INDEX IDX_C2502824D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user_from_id INT DEFAULT NULL, user_to_id INT DEFAULT NULL, object VARCHAR(128) NOT NULL, body LONGTEXT NOT NULL, created_at DATETIME NOT NULL, readen TINYINT(1) NOT NULL, INDEX IDX_B6BD307F20C3C701 (user_from_id), INDEX IDX_B6BD307FD2F7B13D (user_to_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, petsitter_id INT DEFAULT NULL, body LONGTEXT NOT NULL, note SMALLINT NOT NULL, is_active TINYINT(1) NOT NULL, is_validated TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, is_displayed TINYINT(1) NOT NULL, INDEX IDX_9474526C7E3C61F9 (owner_id), INDEX IDX_9474526C6442B64 (petsitter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
